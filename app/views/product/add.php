...
<form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
    <div class="product">
        <b>Артикул (не більше 30 символів тексту):</b> 
        <input type="text" name="newSKU" size="31">
    </div>
    <div class="product">
        <b>Назва (не більше 30 символів тексту):</b> 
        <input type="text" name="newName" size="31">
    </div>
    <div class="product">
        <b>Ціна (не більше 12 цифр цілої частини і не більше 2 цифр дрібної частини (крапка для розділення)):</b> 
    ...
    <div class="product">
        <b>Опис (не більше 50 символів тексту):</b> 
